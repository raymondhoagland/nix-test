{
  ...
  fastlane = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "128c08pwxy9r0444ccp665fdq079kyz2yk6p7d6w95cmrzghzsnr";
      type = "gem";
    };
    version = "2.99.1";
  };
  fastlane-plugin-patch = {
    dependencies = ["pattern_patch"];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1jz3zl0i46gks5wyck2nnh6lmy93dbsxxn0wym5f3a52p2r56i8m";
      type = "gem";
    };
    version = "0.5.0";
  };
  ...
  google-api-client = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0q68gy5ig79jvmnisqwb7jq574chl93s6xjwdd9bmfb4mmi78sdb";
      type = "gem";
    };
    version = "0.21.2";
  };
  ...
  pattern_patch = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0l9s4jz8pk0xjihd83y87wmis714yh56ivmj3fmd25lz5h7v562h";
      type = "gem";
    };
    version = "0.5.5";
  };
  ...
  xcodeproj = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1sglgjq6hkd1mpb8ll38qlgzvixx0bylnv7nvgq8qj005w28szr9";
      type = "gem";
    };
    version = "1.5.9";
  };
